Contributing to barandos Core
============================

The barandos Core project operates an open contributor model where anyone is
...
The following applies to code changes to the barandos Core project, and is not to be
confused with overall barandos Network Protocol consensus changes.

Whether a pull request is merged into barandos Core rests with the project merge
...
Patches that change barandos consensus rules are considerably more involved than
...
Where a patch set proposes to change the barandos consensus, it must have been
...
The project leader is the release manager for each barandos Core release.

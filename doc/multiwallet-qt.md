...
In order to support loading of multiple wallets in barandos-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is barandos.cpp.
...
Changes to barandos.cpp
----------------------
barandos.cpp is the entry point into barandos-qt, and as such, will require some minor modifications to provide hooks for
